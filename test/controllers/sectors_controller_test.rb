...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { Municipality_id: @sector.Municipality_id, description: @sector.description, num_sector: @sector.num_sector } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { Municipality_id: @sector.Municipality_id, description: @sector.description, num_sector: @sector.num_sector } }
