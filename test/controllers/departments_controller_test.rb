...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { description: @department.description, num_depto: @department.num_depto } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { description: @department.description, num_depto: @department.num_depto } }
