...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { Department_id: @municipality.Department_id, description: @municipality.description, num_municip: @municipality.num_municip } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { Department_id: @municipality.Department_id, description: @municipality.description, num_municip: @municipality.num_municip } }
